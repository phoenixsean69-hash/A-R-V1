...
if (
  ...
  console.log(
    `Detected ${v1PartialFiles.size} leftover new model file(s) from an interrupted earlier install. V5 will reuse them safely.`,
  );
}
...
try {
  ...
  console.error(
    "\nModel Phase 1 V5 failed verification/build. All changes were restored.",
  );
...
console.log(`
RoadSafe Model Phase 1 V5 installed successfully.
