...
export function EvidenceWorkspacePanel({
  ...
  return (
    <section
      className={
        standalonePhotos
          ? "min-h-full overflow-hidden border border-gray-200 bg-white shadow-sm"
              ...
              <article key={photo.id} className="overflow-hidden rounded-xl border border-gray-200 bg-white">
                ...
                <div className="space-y-3 p-4">
                  ...
                  <button
                    ...
                    className="w-full rounded-lg border border-[#494949] bg-[#303030] px-3 py-2 text-sm font-semibold text-white"
                  >
