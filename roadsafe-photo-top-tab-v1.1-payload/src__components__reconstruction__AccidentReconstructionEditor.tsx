  ...
  const handleApplyPhotoConstraint = useCallback(
    (constraintId: string) => {
      ...
      try {
        ...
        showSaveMessage(
          `${result.message} Physics is now DIRTY where geometry changed; run Physics again before relying on the previous simulation result.`,
          "info",
          5200,
        );
      } catch (error) {
          ...
          <div className="reconstruction-workspace__view-switch">
            ...
            <button
              ...
              onClick={() => {
                setIsPlaying(false);
                setActiveInvestigationDetail(null);
                setActiveTopWorkspaceTab("photos");
              }}
              className={
                activeTopWorkspaceTab === "photos"
                  ? "is-active"
...
<button
      ...
      <div className="reconstruction-workspace__body">
        {activeTopWorkspaceTab === "photos" ? (
          <div className="h-full min-h-0 overflow-auto bg-[#202020] p-3">
