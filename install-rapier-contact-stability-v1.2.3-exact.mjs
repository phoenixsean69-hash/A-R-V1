...
const PAYLOAD =
  path.join(
    INSTALLER_DIR,
    "roadsafe-rapier-contact-stability-v1.2.3-payload",
  );
...
const backupDir =
  path.join(
    ROOT,
    ".roadsafe-backups",
    `rapier-contact-stability-v1.2.3-${stamp}`,
  );
...
console.log("");
console.log(
  "RoadSafe Rapier Contact Stability + Attached Damage V1.2.3 — EXACT LOCAL",
);
console.log(
  "==========================================================",
);
...
if (
  ...
  console.error("");
  console.error(
    "[RoadSafe] Rolling V1.2.3 back automatically...",
  );
...
console.log("");
console.log(
  "Rapier Contact Stability + Attached Damage V1.2.3 is installed.",
);
console.log(
  "Run: npm run dev",
);
