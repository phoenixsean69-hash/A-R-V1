...
const statePath = path.join(
  backupRoot,
  "last-scene-collection-hq-dragdrop-v1.json",
);

const buildLogPath = path.join(
  backupRoot,
  "scene-collection-hq-dragdrop-v1-build.log",
);
...
if (!pointZ.includes("ReconstructionParticipantAssetId")) {
  pointZ = replaceOnce(
    pointZ,
  ...
  ReconstructionVehicle,`,
    "ReconstructionParticipantAssetId type import",
  );
}

if (!pointZ.includes("assetId?: ReconstructionParticipantAssetId;")) {
  pointZ = replaceOnce(
    pointZ,
  ...
  assetId?: ReconstructionParticipantAssetId;
    ...
    "PendingParticipantPlacement interface",
  );
}
...
if (!editor.includes("DragEvent as ReactDragEvent")) {
  ...
  PointerEvent as ReactPointerEvent,
    ...
    "React pointer-event type import",
  );
}
...
`  type ReconstructionPosition,
  type ReconstructionParticipantAssetId,
  type ReconstructionSceneObject,
  type ReconstructionVehicleType,
  type SceneObjectType,`,
    "3D reconstruction type imports",
  );
}
...
const buildOutput = [
  "RoadSafe Blender Scene Collection HQ Drag/Drop V1",
  "=================================================",
...
console.log("");
console.log(
  "RoadSafe Blender Scene Collection HQ Drag/Drop V1 installed successfully.",
);
...
console.log(
  "  node revoke-scene-collection-hq-dragdrop-v1.mjs",
);
