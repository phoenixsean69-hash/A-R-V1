...
if (!fs.existsSync(VIEWER)) {
  fail(
    `Could not find ${VIEWER_REL}. Run this installer from the A-R-V1 repository root.`,
  );
}
...
if (
  !originalViewer.includes(
    'createRoadSafeViewportPolish',
  )
) {
  fail(
    "Viewport Polish V2 does not appear to be installed in Reconstruction3DViewer.tsx. Install V2 first or send the current viewer file.",
  );
}
...
const backupDir =
  path.join(
    ROOT,
    ".roadsafe-backups",
    `main-3d-viewport-polish-v3-${stamp}`,
  );
...
console.log("");
console.log(
  "RoadSafe Main 3D Viewport Polish V3",
);
console.log(
  "===================================",
);
console.log(
  "[OK] Replaced giant scene arrows with subtle axis lines.",
);
console.log(
  "[OK] Locked orientation gizmo to a 92 × 92 px wrapper.",
);
console.log(
  "[OK] Protected gizmo from repo-wide canvas sizing CSS.",
);
console.log(
  "[OK] Kept fine + major grid floor.",
);
console.log(
  "[OK] Kept axis-click camera snapping.",
);
console.log(
  "[OK] No physics or reconstruction-state changes.",
);
console.log(
  `[OK] Backup: ${backupDir}`,
);
...
if (!tscCli) {
  console.log("");
  console.log(
    "[WARN] TypeScript CLI not found. Automatic verification skipped.",
  );
  console.log(
    "Run: npm run build",
  );
