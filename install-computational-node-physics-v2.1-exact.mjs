...
console.log("");
console.log("RoadSafe Computational Node + Physics V2.1 — EXACT LOCAL");
console.log("======================================================");
...
const backupDir = path.join(
  ROOT,
  ".roadsafe-backups",
  `computational-node-physics-v2.1-exact-${stamp}`,
);
...
console.log("");
console.log("Installed behavior (V2.1 type-safe speed sync):");
...
console.log("  • participant Speed sync now constructs a complete type-safe physics profile");
