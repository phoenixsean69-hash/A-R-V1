      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
        {cards.map(
          ({
            ...
            >
              <div className="grid h-11 w-11 shrink-0 place-items-center rounded-md border border-[#80ACFF] bg-[#303030] text-[#80ACFF] transition-colors group-hover:border-[#80ACFF]">
                <Icon size={20} strokeWidth={1.55} />
              </div>

              <div className="min-w-0">
                <p className="truncate text-[9px] font-bold uppercase tracking-[0.12em] text-[#80ACFF]">
                  {label}
                </p>
