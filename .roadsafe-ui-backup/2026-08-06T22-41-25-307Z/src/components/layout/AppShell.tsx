...
export default function AppShell() {
  ...
  const shellClassName = [
    ...
    mobileOpen
      ...
      : "",
    mobileInspectorOpen && inspectorAvailable
      ? "is-mobile-inspector-open"
      : "",
    isReconstructionWorkspace
      ? "is-editor-route"
      : "",
  ...
  function toggleInspector(): void {
    ...
    setMobileInspectorOpen((value) => !value);
  }
  ...
  return (
    <div className={shellClassName}>
      ...
      <button
        type="button"
        className="roadsafe-mobile-overlay roadsafe-inspector-overlay"
        onClick={() =>
          setMobileInspectorOpen(false)
        }
