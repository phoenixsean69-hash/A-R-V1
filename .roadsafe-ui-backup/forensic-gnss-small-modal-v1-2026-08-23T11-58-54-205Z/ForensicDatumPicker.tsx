...
export default function ForensicDatumPicker({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] bg-black/90 p-3 sm:p-4">
      <section className="mx-auto flex h-full w-full max-w-[1600px] flex-col overflow-hidden rounded-xl border border-[#454545] bg-[#1f1f1f] shadow-[0_25px_120px_rgba(0,0,0,.72)]">
        <header className="flex shrink-0 items-start justify-between gap-4 border-b border-[#3d3d3d] bg-[linear-gradient(180deg,#2b2b2b_0%,#242424_100%)] px-5 py-4">
          <div className="min-w-0">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-3">
              <h2 className="text-[28px] font-bold leading-none text-slate-100">
            ...
            <p className="mt-3 max-w-4xl text-[13px] leading-6 text-slate-400">
              The officer must physically stand at a permanent scene feature.
              RoadSafe captures the device GNSS position and stores its reported
              uncertainty. No manual map picking is used.
            </p>
          </div>
          ...
          <button
            ...
            className="grid h-11 w-11 shrink-0 place-items-center rounded-lg border border-[#4a4a4a] bg-[#2b2b2b] text-xl text-slate-300 hover:bg-[#343434]"
        ...
        <div className="grid min-h-0 flex-1 gap-4 overflow-y-auto p-4 xl:grid-cols-[minmax(0,1fr)_370px]">
            ...
            <section className="rounded-xl border border-[#3e3e3e] bg-[#242424] p-4">
              <div className="mb-4 flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-[12px] text-slate-500">
                    Use this as a fast field checklist.
                  </p>
                </div>
              </div>
              ...
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                ...
                <StepCard
                  ...
                  text="Press the capture button and let RoadSafe sample multiple fixes before confirming."
                />
              </div>
            </section>
            ...
            <section className="rounded-xl border border-[#3e3e3e] bg-[#242424] p-4">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-[12px] text-slate-500">
                    Start only when the officer is standing exactly at the chosen reference feature.
                  </p>
                </div>
                ...
                {status ===
                  ...
                  <button
                    ...
                    className="rounded-lg border border-[#565656] bg-[#303030] px-4 py-2 text-[12px] font-semibold text-slate-300 hover:bg-[#3a3a3a]"
                  >
                    Cancel capture
                  </button>
                )}
              ...
              <div className="mt-4 grid gap-3 lg:grid-cols-[minmax(0,1fr)_320px]">
                <div className="rounded-xl border border-[#5f4822] bg-[linear-gradient(180deg,#2b2212_0%,#221b10_100%)] p-5">
                  <p className="text-[12px] leading-6 text-[#dfc27f]">
                    Hold the device steady at the exact permanent feature.
                    RoadSafe will sample up to{" "}
                  ...
                  <button
                    ...
                    className="mt-4 rounded-lg border border-[#8c6039] bg-[#3a2c21] px-5 py-3 text-[13px] font-bold uppercase tracking-[0.04em] text-[#f0c49a] hover:bg-[#453225] disabled:cursor-not-allowed disabled:opacity-40"
                  >
              ...
              <section className="rounded-xl border border-[#3e3e3e] bg-[#242424] p-4">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-[12px] text-slate-500">
                      Review the captured coordinate and uncertainty before confirming.
                    </p>
                  </div>
          ...
          <aside className="min-w-0 space-y-4">
            ...
            <section className="rounded-xl border border-[#3e3e3e] bg-[#242424] p-4">
              ...
              <div className="mt-4 space-y-2">
                ...
                <DataRow
                  label="Sampling"
                  value={`${TARGET_SAMPLES} fixes / ${CAPTURE_WINDOW_MS / 1000}s`}
                />
              </div>
            </section>
            ...
            <section className="rounded-xl border border-[#3e3e3e] bg-[#242424] p-4">
              ...
              <p className="mt-3 text-[12px] leading-6 text-slate-400">
                RoadSafe stores the reported GNSS uncertainty. This datum georeferences the scene; fine forensic measurements should still be captured with tape, laser, total station, photogrammetry, or other appropriate tools.
              </p>
            </section>
...
function StatCard({
  ...
  return (
    <div className="rounded-xl border border-[#3f3f3f] bg-[#1d1d1d] px-4 py-4">
      ...
      <p className="mt-3 break-all text-[18px] font-bold leading-none text-slate-100">
        {value}
      </p>
    </div>
  );
...
function DataRow({
  ...
  return (
    <div className="grid grid-cols-[88px_1fr] items-start gap-3 rounded-lg border border-[#3f3f3f] bg-[#1d1d1d] px-3 py-2.5">
