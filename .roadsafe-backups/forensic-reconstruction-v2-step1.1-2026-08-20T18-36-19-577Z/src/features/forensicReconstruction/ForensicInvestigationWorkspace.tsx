          ...
          {section === "Scene Intake" && (
            <section className="fv2-panel">
              ...
              <div className="fv2-grid">
                ...
                {field("Weather", "weather", "clear, rain, fog...")}
                {field("Lighting", "lighting", "daylight, dark, street-lit...")}
                {field("Road condition", "roadCondition", "dry, wet, loose surface...")}
                {field("Traffic-control state", "trafficControlState", "signals, signs, temporary control...")}
                {field("Road geometry", "roadGeometry", "straight, curve, junction, lanes, grade...")}
