          ...
          {section === "Scene Intake" && (
            <section className="fv2-panel">
              ...
              <div className="fv2-grid">
                ...
                {field(
                  "Scene datum / fixed reference",
                  "sceneDatumLabel",
                  "e.g. Lamp post LP-04 base = (0,0)",
                )}
                {field(
                  "Coordinate convention",
                  "coordinateNotes",
                  "e.g. +X east along road, +Y north across carriageway",
                )}
                ...
                <div className="fv2-grid">
                  ...
                  <div className="fv2-field full">
                    ...
                    <div className="fv2-coordinates">
                      <label><span>X (m)</span><input inputMode="decimal" value={evidenceX} onChange={(e) => setEvidenceX(e.target.value)} /></label>
                      <label><span>Y (m)</span><input inputMode="decimal" value={evidenceY} onChange={(e) => setEvidenceY(e.target.value)} /></label>
                    ...
                    <small className="fv2-help">Datum: {investigation.scene.sceneDatumLabel || "not defined yet"}</small>
                  </div>
              ...
              <section className="fv2-panel">
                ...
                <div className="fv2-grid">
                  ...
                  <label className="fv2-field full">
                    <span>Measurement method / source</span>
                    <input
                      value={measurementMethod}
                      onChange={(e) => setMeasurementMethod(e.target.value)}
                      placeholder="laser distance meter, tape, CCTV calibration, calculation..."
                    />
                  </label>

                  <label className="fv2-field full">
                    <span>Location / reference description</span>
                    <input
                      value={measurementLocation}
                      onChange={(e) => setMeasurementLocation(e.target.value)}
                      placeholder="e.g. skid onset to final visible tyre mark"
                    />
                  </label>
              ...
              <section className="fv2-panel">
                <header>
                  ...
                  <small className="fv2-plan-datum">
                    Datum: {investigation.scene.sceneDatumLabel || "(0,0) not labelled"}
                  </small>
                </header>
                ...
                <div className="fv2-plan-footer">
                  ...
                  <span>{investigation.scene.coordinateNotes || "Coordinate convention not recorded"}</span>
                </div>
              </section>
            </div>
          )}
