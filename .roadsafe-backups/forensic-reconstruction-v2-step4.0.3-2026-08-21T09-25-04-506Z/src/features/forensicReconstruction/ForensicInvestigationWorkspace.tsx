...
export default function ForensicInvestigationWorkspace({
  ...
  const addPerson = () => {
    ...
    if (
      ...
      setMessage(
        "Check the National Driver Registry before adding this driver. If the registry is unavailable, the failed/unavailable check will still be recorded.",
      );
      return;
    }
      ...
      <div className="fv2-layout">
        <aside className="fv2-sidebar">
          ...
          {SECTIONS.map((item) => (
            ...
            >
              <span>{item}</span>
              <small>{ACTIVE.has(item) ? (item === "Persons" ? "Step 4" : "Ready") : "Later"}</small>
            </button>
          ))}
        </aside>
          ...
          {section === "Overview" && (
            <div className="fv2-stack">
              <section className="fv2-hero">
                ...
                <strong>STEP 4<br /><span>PERSONS</span></strong>
              </section>
              ...
              <div className="fv2-stats">
                ...
                <article><span>Vehicles</span><strong>{investigation.vehicles.length}</strong><small>examined / registered vehicles</small></article>
                <article><span>Persons</span><strong>{investigation.persons.length}</strong><small>people physically involved</small></article>
              </div>
                ...
                <div className="fv2-grid">
                  ...
                  <label className="fv2-field">
                    ...
                    <input
                      ...
                      onChange={(e) => setPersonIdentityNumber(e.target.value)}
                  ...
                  <label className="fv2-field full">
                    ...
                    <input
                      ...
                      onChange={(e) => setPersonLicenceNumber(e.target.value)}
                  ...
                  {personInvolvement.trim().toLowerCase() === "driver" && (
                    <section className="fv2-driver-registry-card full">
                      <div className="fv2-driver-registry-head">
                        <div>
                          <span>National Driver Registry</span>
                          <strong>CVR / ZIMTIS driver verification</strong>
                          <small>
                            Verify that the person is registered as a driver and check the licence status/codes returned by the authorised registry gateway.
                          </small>
                        </div>
                        ...
                        >
                          {personDriverRegistryBusy
                            ? "Checking registry..."
                            : "Check National Driver Registry"}
                        </button>
                      </div>

                      <div className="fv2-driver-registry-connection">
                        Connection: {DriverRegistryService.getConnectionMode() === "official"
                          ? "Authorised registry gateway configured"
                          : DriverRegistryService.getConnectionMode() === "demo"
                            ? "DEMO MODE — not an official registry lookup"
                            : "Official registry gateway not configured"}
                      </div>
                      ...
                      {personDriverRegistryCheck ? (
                        <div className={`fv2-driver-registry-result ${
                          ...
                          <div className="fv2-driver-registry-grid">
                            <div>
                              ...
                              <strong>{personDriverRegistryCheck.matchedFullName || "Not returned"}</strong>
                            </div>
                            <div>
                        ...
                        <div className="fv2-driver-registry-empty">
                          No registry check has been recorded for this driver yet.
                        </div>
                      )}
                    </section>
                  )}
                  ...
                  <label className="fv2-field full">
                    ...
                    <small className="fv2-help">
                      Link drivers or occupants to an examined vehicle. Pedestrians and others can remain unlinked.
                    </small>
                  </label>
