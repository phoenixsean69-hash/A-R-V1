...
const PAYLOAD =
  path.join(
    INSTALLER_DIR,
    "roadsafe-speed-start-continuity-v1.1.1-payload",
  );
...
const backupDir =
  path.join(
    ROOT,
    ".roadsafe-backups",
    `speed-start-continuity-v1.1.1-${stamp}`,
  );
...
console.log("");
console.log(
  "RoadSafe Participant Speed Start Continuity V1.1.1 — EXACT LOCAL",
);
...
console.log(
  "[FIX] Both speed-update physics assignments now begin from getDefaultParticipantPhysics(...).",
);
console.log(
  "[FIX] ParticipantPhysicsProfile.enabled and every other required physics field remain defined.",
);
...
if (
  ...
  console.error("");
  console.error(
    "[RoadSafe] Rolling V1.1.1 back automatically...",
  );
...
console.log("");
console.log(
  "Participant Speed Start Continuity V1.1.1 is installed.",
);
