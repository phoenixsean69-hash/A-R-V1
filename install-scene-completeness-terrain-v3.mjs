...
const statePath =
  path.join(
    backupRoot,
    "last-scene-completeness-terrain-v3.json",
  );

const buildLogPath =
  path.join(
    backupRoot,
    "scene-completeness-terrain-v3-build.log",
  );
...
const output =
  [
    "RoadSafe Scene Completeness + Terrain V3",
    "========================================",
    `status: ${String(
      build.status,
    )}`,
...
console.log("");
console.log(
  "RoadSafe Scene Completeness + Terrain V3 installed successfully.",
);
...
console.log(
  "  node revoke-scene-completeness-terrain-v3.mjs",
);
