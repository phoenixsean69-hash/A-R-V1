...
`export type ReconstructionEntityColour =`;
    ...
    if (
      ...
      console.error(
        "Could not locate ReconstructionEntityColour.",
      );
      process.exit(1);
    }
...
`  type: ReconstructionEntityType;
  ...
  colour: ReconstructionEntityColour;`,
        "ReconstructionEntity type/colour fields",
      );
  }
...
try {
  ...
  console.error(
    "\nModel Phase 1 failed verification/build. All changes were restored.",
  );
...
console.log(`
RoadSafe Model Phase 1 installed successfully.
