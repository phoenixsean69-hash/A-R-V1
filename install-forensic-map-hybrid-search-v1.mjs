...
const payloadCssPath =
  path.join(
    scriptDir,
    "forensic-map-hybrid-search-v1.css",
  );
...
const buildLogPath =
  path.join(
    backupRoot,
    "forensic-map-hybrid-search-v1-build.log",
  );

const CSS_START =
  "/* [RoadSafe:ForensicMapHybridSearchV1:start] */";

const CSS_END =
  "/* [RoadSafe:ForensicMapHybridSearchV1:end] */";
...
const output =
  [
    "RoadSafe Forensic Map Hybrid + Search V1",
    "========================================",
    `status: ${String(
      build.status,
    )}`,
...
console.log("");
console.log(
  "RoadSafe Forensic Map Hybrid + Search V1 installed successfully.",
);
...
console.log(
  "  node revoke-forensic-map-hybrid-search-v1.mjs",
);
