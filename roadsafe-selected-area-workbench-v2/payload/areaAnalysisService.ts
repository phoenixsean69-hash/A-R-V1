...
export class AreaAnalysisService {
  static analyse(
    ...
    const junctionsInsideArea = allJunctions.filter(
      (junction) =>
    ...
    return {
      ...
      areaSquareKilometres:
        this.calculateArea(bounds),
      overallRiskLevel:
        RiskAnalysisService.classifyScore(
          averageRiskScore,
        ),
    };
  }
