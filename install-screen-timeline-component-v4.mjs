...
const buildLogPath =
  path.join(
    backupRoot,
    "screen-timeline-component-v4-build.log",
  );
...
function restoreV4() {
  ...
  console.log(
    "RESTORED clean pre-V4 timeline state.",
  );
}
...
try {
  ...
  console.log(
    "V4 editor + component TSX parse audit: PASS",
  );
} catch (error) {
  if (
...
if (build.status !== 0) {
  ...
  console.error(
    "Restoring clean pre-V4 timeline state...",
  );
...
console.log("");
console.log(
  "RoadSafe Screen Timeline Component V4 installed successfully.",
);
console.log("");
console.log(
  "Architecture:",
...
console.log(
  "  node revoke-screen-timeline-component-v4.mjs",
);
