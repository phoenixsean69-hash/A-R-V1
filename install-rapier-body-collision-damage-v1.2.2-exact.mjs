...
const PAYLOAD =
  path.join(
    INSTALLER_DIR,
    "roadsafe-rapier-body-damage-v1.2.2-payload",
  );
...
const backupDir =
  path.join(
    ROOT,
    ".roadsafe-backups",
    `rapier-body-collision-damage-v1.2.2-${stamp}`,
  );
...
console.log("");
console.log(
  "RoadSafe Rapier Body Collision + Damage V1.2.2 — EXACT LOCAL",
);
console.log(
  "==========================================================",
);
...
if (
  ...
  console.error("");
  console.error(
    "[RoadSafe] Rolling V1.2.2 back automatically...",
  );
...
console.log("");
console.log(
  "Rapier Body Collision + Damage V1.2.2 is installed.",
);
console.log(
  "Run: npm run dev",
);
