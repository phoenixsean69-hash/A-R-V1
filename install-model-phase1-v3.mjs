...
if (
  ...
  console.log(
    `Detected ${v1PartialFiles.size} leftover new model file(s) from an interrupted earlier install. V3 will reuse them safely.`,
  );
}
...
try {
  ...
  console.error(
    "\nModel Phase 1 V3 failed verification/build. All changes were restored.",
  );
...
console.log(`
RoadSafe Model Phase 1 V3 installed successfully.
