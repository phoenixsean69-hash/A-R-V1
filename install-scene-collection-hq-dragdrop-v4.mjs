...
const buildLogPath = path.join(
  backupRoot,
  "scene-collection-hq-dragdrop-v4-build.log",
);
...
const buildOutput = [
  "RoadSafe Blender Scene Collection HQ Drag/Drop V4",
  "=================================================",
...
console.log("");
console.log(
  "RoadSafe Blender Scene Collection HQ Drag/Drop V4 installed successfully.",
);
...
console.log(
  "  node revoke-scene-collection-hq-dragdrop-v4.mjs",
);
