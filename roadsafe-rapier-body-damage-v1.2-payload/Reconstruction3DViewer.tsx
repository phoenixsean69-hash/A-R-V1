...
function populateParticipantDamageVisual(
  ...
  /*
   * Deterministic small fragments/crumple ridges so damage reads clearly
   * without introducing random/non-repeatable visual output.
   */
  const shardMaterial =
    new THREE
      .MeshStandardMaterial({
...
function applyParticipantDamagePose(
  ...
  /*
   * Keep the damage overlay on the same post-impact pitch/roll pose without
   * inheriting the body's crush scaling a second time.
   */
