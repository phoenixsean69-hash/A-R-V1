...
const PAYLOAD =
  path.join(
    INSTALLER_DIR,
    "roadsafe-human-rest-true-braking-v1.0.1-payload",
  );
...
const backupDir =
  path.join(
    ROOT,
    ".roadsafe-backups",
    `human-rest-true-braking-v1.0.1-${stamp}`,
  );
...
console.log("");
console.log(
  "RoadSafe Human Rest + True Emergency Braking V1.0.1 — EXACT LOCAL",
);
console.log(
  "==============================================================",
);
...
console.log(
  "[FIX] Removed the unused total variable from reconstructionHumanKnockdown.ts.",
);
console.log(
  "[FIX] No human-rest, braking, Rapier trajectory, or reaction behavior was changed by this compile fix.",
);
...
if (
  ...
  console.error("");
  console.error(
    "[RoadSafe] Rolling Human Rest + True Emergency Braking V1.0.1 back automatically...",
  );
...
console.log("");
console.log(
  "Human Rest + True Emergency Braking V1.0.1 is installed.",
);
