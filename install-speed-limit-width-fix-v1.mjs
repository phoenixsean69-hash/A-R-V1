...
const statePath = path.join(backupRoot, "last-speed-limit-width-fix-v1.json");
...
for (const token of [
  ...
  'data-roadsafe-speed-limit-input',
...
console.log('');
console.log('RoadSafe speed-limit width fix installed.');
...
console.log('  node revoke-speed-limit-width-fix-v1.mjs');
